<%@ Page Title="" Language="C#" MasterPageFile="~/TestMaster.Master" AutoEventWireup="true" CodeBehind="SupplierBarang.aspx.cs" Inherits="TestWeb.SupplierBarang" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="Panl1" runat="server" CssClass="Popup" align="center" Style="display: none">
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="lblKode" Text="Kode Supplier" runat="server"></asp:Label>
                        </td>
                        <td>:</td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label1" Text="Nama Supplier" runat="server"></asp:Label>
                        </td>
                        <td>:</td>
                        <td>
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <asp:GridView ID="grdSup" RowStyle-CssClass="alt" runat="server" CssClass="grid" AutoGenerateColumns="false">
                            <Columns>
