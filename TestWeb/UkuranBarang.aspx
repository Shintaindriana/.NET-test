<%@ Page Title="" Language="C#" MasterPageFile="~/TestMaster.Master" AutoEventWireup="true" CodeBehind="UkuranBarang.aspx.cs" Inherits="TestWeb.UkuranBarang" %>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="Panl1" runat="server" CssClass="Popup" align="center" Style="display: none">
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="lblKode" Text="Kode Ukuran" runat="server"></asp:Label>
                        </td>
                        <td>:</td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label1" Text="Ukuran" runat="server"></asp:Label>
                        </td>
                        <td>:</td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label2" Text="Jumlah 1 Dus" runat="server"></asp:Label>
                        </td>
                        <td>:</td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label3" Text="Jumlah M2 Dus" runat="server"></asp:Label>
                        </td>
                        <td>:</td>
                        <td>
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <asp:GridView ID="grdUkuran" RowStyle-CssClass="alt" runat="server" CssClass="grid" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:BoundField DataField="KODE_UKURAN" HeaderText="Kode Ukuran" />
                                <asp:BoundField DataField="UKURAN" HeaderText="Ukuran" />
                                <asp:BoundField DataField="JUMLAH_1_DUS" HeaderText="Jumlah 1 Dus" />
                                <asp:BoundField DataField="JUMLAH_M2_DUS" HeaderText="Jumlah M2 Dus" />
                            </Columns>
                        </asp:GridView>
                    </td>
                </tr>
